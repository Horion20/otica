...
export const ImportModal: React.FC<ImportModalProps> = ({ isOpen, onClose, onImport }) => {
  ...
  // --- HANDLERS FOR IMAGE/LINK (Always AI) ---
             ...
             <>
                ...
                {activeTab === 'image' && (
                    <div className="space-y-6 h-full flex flex-col">
                        <div className="bg-yellow-50 text-yellow-800 p-3 rounded-lg text-xs flex items-center gap-2">
                           <i className="fas fa-info-circle"></i>
                           <span>A importação por imagem/link sempre utiliza Inteligência Artificial.</span>
                        </div>
                    ...
                    <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-2">
                      ...
                      <div>
                         ...
                         <p className="text-xs font-mono text-slate-600">
                            {frame.purchasePrice > 0 ? `R$ ${frame.purchasePrice}` : '-'}
                         </p>
                      </div>
                    </div>
                    <button 
